...
\pred{intervalosValidos}{intervalos : \TLista{intervalo}, durTotal : tiempo}{\\
	\tab intervalosEnRango(intervalos, durTotal) \\
    \tab \y enOrden(intervalos) \\
    \tab \y \,todosConPrecision(intervalos, 2)}
...
\pred{todosConPrecision}{intervalos : \TLista{intervalo}, precision : \ent}{\\
\tab (\forall p : intervalo) \
p \in intervalos \implicaLuego (conPrecision(p_0, precision) \y conPrecision(p_1, precision)}
...
\tab \tab (inter_1 - inter_0 > 0.1 \y conPrecision(inter_0, 2) \y conPrecision(inter_1, 2)) \yLuego \\
